...
!======================================================================================================!
  ...
  spline_points = 600
  bound = [1,40,1,40]         ! size of surface (1-min x, 2-max x, 3-min y, 4-max y)
...
!$omp end parallel 
  ...
  nsurface = int(area*0.10d0)
  init_num(1) = 0 ; init_num(2) = 0 ; init_num(3) = 0
  init_num(4) = nsurface ; print*,'Num D',nsurface
