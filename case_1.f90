...
!======================================================================================================!
  ...
  integer, parameter :: atomType = 3              ! # of different types of atoms
...
!======================================================================================================!
    ...
    Edes = [1.00d0,1.00d0,0.08d0]     ! Grabow, Mavrikakis : Mechanims of Methanol Synthesis
    Edif = [0.60d0,0.60d0,1.00d0]    ! Gomer_90 

    lateral_energy = [-0.10d0,-0.10d0,0.0d0]
...
!======================================================================================================!
    ...
    if (atom(n)%id == 1) atom(n)%rates(3,1) = des_rate(1)
    if (atom(n)%id == 2) atom(n)%rates(3,1) = des_rate(2)
    if (atom(n)%id == 3) atom(n)%rates(3,1) = des_rate(3)
...
!======================================================================================================!
    ...
    !print*,'lateral vs regular',lateral_rate
    !print*,lateral_dif_rate
    !print*,rate_val(1)
    !print*,Ea(1)+lateral_energy,Ea(1)+2.0d0*lateral_energy
